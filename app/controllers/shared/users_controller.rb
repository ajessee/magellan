  ...
  class UsersController < ApplicationController
    ...
    def create
      if existing_guest_user?
        ...
        guest_user_params = update_guest_params(@user,
                                                params.require(:user).permit(:first_name, :last_name, :details, :image, :email, :password, :password_confirmation,
                                                                             :update_type))
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :details, :image, :resume, :email, :password,
                                   :password_confirmation, :update_type)
    end
    ...
    def correct_user
      ...
      unless current_user?(@user) || current_user&.admin?
        flash[:error_message] =
          "You definitely shouldn\'t be trying to access another user\'s resources #{@user.first_name}"
